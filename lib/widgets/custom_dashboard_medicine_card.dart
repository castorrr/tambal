// File: custom_dashboard_medicine_card.dart
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
        ...
        Container(
          width:
              MediaQuery.of(context).size.width, // Expands to full screen width
          padding: const EdgeInsets.all(16.0),
          decoration: BoxDecoration(
            color:
                Colors.blue.shade100, // Custom background color for the section
